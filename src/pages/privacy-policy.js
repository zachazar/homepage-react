...
const PrivacyPolicy = () => (
	<Layout>
		<SEO
			...
			keywords={['zach azar', 'privacy policy', 'blog']}
		/>
		<div className="content" style={{ padding: '2rem' }}>
			...
			<p>
				...
				provide on the <Link to="/">zachazar.com</Link> website
				...
				&quot;us&quot; or &quot;our&quot;). By accessing and using the Website
			...
			<p>
				...
				fill any online forms on the Website. Some of the information we collect
				is directly from you via the Website and Services. However, we may also
				collect Personal Information about you from other sources such as public
				databases and our joint marketing partners. You can choose not to
				provide us with your Personal Information, but then you may not be able
				to take advantage of some of the features on the Website. Users who are
			...
			<p>
				...
				statistical purposes to operate the Website and Services. Most web
				browsers automatically accept cookies, but you can usually modify your
				browser setting to decline cookies if you prefer. You may learn more
				about cookies and how they work in this{' '}
				<a
					target="_blank"
					rel="noreferrer"
				...
				. Please also read our <Link to="/cookie-policy">cookie policy</Link> to
				learn more.
			</p>
