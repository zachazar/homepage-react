	...
	<Layout>
		...
		<div className={cx('columns', styles.items)}>
			...
			<div className={cx('column', styles.aboutItem)}>
				...
				<p>
					After graduating, I was a technical co-founder briefly (it didn&apos;t
					...
					<a href="https://www.buildingconnected.com/bid-board/" target="blank">
						Bid Board
					</a>
					).
				</p>
				<p>
					...
					out of Seattle. Check out <Link to="/resume">the Résumé page</Link> to
					see all of the skills I&apos;ve picked up along the way.
				</p>
				<p>
