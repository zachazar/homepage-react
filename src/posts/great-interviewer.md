...
Take an implicit bias test (like [the Gender-Career and Gender-Science tests from Harvard](https://implicit.harvard.edu/implicit/takeatest.html)) and discuss the results as a team.
